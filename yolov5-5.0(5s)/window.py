...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        weights = 'runs/train/exp/weights/best.pt'   # 模型加载路径
        imgsz = 640  # 预测图尺寸大小
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "PCB表面缺陷检测平台"))
        ...
        self.pushButton_showdir.setText(_translate("MainWindow", "打开文件夹"))
    ...
    def button_image_open(self):
        ...
        self.result = cv2.resize(self.result, (1280, 960), interpolation=cv2.INTER_AREA)
